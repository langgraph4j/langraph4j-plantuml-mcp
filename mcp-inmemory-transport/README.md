...
‼️ **Note** ‼️
> This module has been submitted as [Pull Request #512](https://github.com/modelcontextprotocol/java-sdk/pull/512) to the main project [modelcontextprotocol/java-sdk](https://github.com/modelcontextprotocol/java-sdk) 
...
```xml
<dependency>
    <groupId>org.bsc.modelcontextprotocol.sdk</groupId>
